...
import { removeAllSelectionsButLast } from './utils/index'
...
export default {
  ...
  /**
   * @normal select to the next occurrence of given character
   * @goto go to file
  ...
  f: withGoto(
    ...
    {},
    (editor, { instance }) =>
      instance.updateSelectToChar({ withFoundChar: true })
  ),
  /**
   * @goto go to buffer
  ...
  /**
   * @normal select until the next occurrence of given character
  ...
  t: withGoto(
    ...
    { removeMultipleSelections: true },
    (editor, { instance }) =>
      instance.updateSelectToChar({ withFoundChar: false })
  ),
  /**
