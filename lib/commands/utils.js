...
export const withGoto = (withGotoFn, config = {}, defaultFn) => (entity, aux) => {
    ...
    if (withGotoFn) {
      ...
      withGotoFn(entity, {
        ...
        ...removeMultipleSelections && {
          ...
          lastCursor: aux.editor.getCursorAtScreenPosition(aux.editor.getCursorScreenPosition()),
        },
      })
    }
  } else {
...
export const getMovementCommand = type => (cursor, { modifier, isGoToActive }) => {
  if (modifier === 'shift') {
